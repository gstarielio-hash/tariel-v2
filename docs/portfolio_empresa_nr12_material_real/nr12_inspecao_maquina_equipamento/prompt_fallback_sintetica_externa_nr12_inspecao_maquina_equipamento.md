# Prompt Fallback Sintetica Externa - NR12 - Inspecao maquina equipamento
...
```text
Quero que voce gere um pacote sintetico externo completo para a familia Tariel `nr12_inspecao_maquina_equipamento`.
...
Regra de produto:
- a familia principal e `nr12_inspecao_maquina_equipamento`;
- o template principal deve ser `nr12_inspecao_maquina_equipamento`;
...
- `output/nr12_inspecao_maquina_equipamento/assets/`
- `output/nr12_inspecao_maquina_equipamento/pdf/`
- `output/nr12_inspecao_maquina_equipamento/manifest.json`
- `output/nr12_inspecao_maquina_equipamento/tariel_filled_reference_bundle.json`
- `output/nr12_inspecao_maquina_equipamento/pdf/nr12_inspecao_maquina_equipamento_referencia_sintetica.pdf`
