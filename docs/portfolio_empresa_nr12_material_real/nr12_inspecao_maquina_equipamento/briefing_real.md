...
- kind: `inspection`
- wave: `1`
- template_codes: `nr12_inspecao_maquina_equipamento`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr12_inspecao_maquina_equipamento.
...
- prompt excepcional salvo em `prompt_fallback_sintetica_externa_nr12_inspecao_maquina_equipamento.md`
...
Descricao canonica da familia: Execucao do servico inspecao maquina equipamento no contexto da norma seguranca no trabalho em maquinas e equipamentos, com consolidacao de evidencias, registros de campo ou base documental e conclusao tecnica auditavel.
