# Prompt Fallback Sintetica Externa - NR20 - Inspecao instalacoes inflamaveis
...
```text
Quero que voce gere um pacote sintetico externo completo para a familia Tariel `nr20_inspecao_instalacoes_inflamaveis`.
...
Regra de produto:
- a familia principal e `nr20_inspecao_instalacoes_inflamaveis`;
- o template principal deve ser `nr20_inspecao_instalacoes_inflamaveis`;
...
- `output/nr20_inspecao_instalacoes_inflamaveis/assets/`
- `output/nr20_inspecao_instalacoes_inflamaveis/pdf/`
- `output/nr20_inspecao_instalacoes_inflamaveis/manifest.json`
- `output/nr20_inspecao_instalacoes_inflamaveis/tariel_filled_reference_bundle.json`
- `output/nr20_inspecao_instalacoes_inflamaveis/pdf/nr20_inspecao_instalacoes_inflamaveis_referencia_sintetica.pdf`
