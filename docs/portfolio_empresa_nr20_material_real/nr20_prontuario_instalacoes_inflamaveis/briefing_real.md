# NR20 - Prontuario instalacoes inflamaveis

- family_key: `nr20_prontuario_instalacoes_inflamaveis`
- macro_categoria: `NR20`
- kind: `documentation`
- wave: `1`
- template_codes: `nr20_prontuario_instalacoes_inflamaveis`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr20_prontuario_instalacoes_inflamaveis.
...
- prompt excepcional salvo em `prompt_fallback_sintetica_externa_nr20_prontuario_instalacoes_inflamaveis.md`
...
Descricao canonica da familia: Execucao do servico prontuario instalacoes inflamaveis no contexto da norma seguranca e saude no trabalho com inflamaveis e combustiveis, com consolidacao de evidencias, registros de campo ou base documental e conclusao tecnica auditavel.
