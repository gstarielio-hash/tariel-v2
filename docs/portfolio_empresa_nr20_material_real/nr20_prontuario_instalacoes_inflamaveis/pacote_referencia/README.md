...
Familia: `nr20_prontuario_instalacoes_inflamaveis`
...
- se faltar base, usar o fallback externo em `../prompt_fallback_sintetica_externa_nr20_prontuario_instalacoes_inflamaveis.md`
