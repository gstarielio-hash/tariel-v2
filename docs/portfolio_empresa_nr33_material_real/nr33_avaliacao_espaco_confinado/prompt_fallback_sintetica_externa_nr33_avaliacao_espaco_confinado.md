# Prompt Fallback Sintetica Externa - NR33 - Avaliacao espaco confinado
...
```text
Quero que voce gere um pacote sintetico externo completo para a familia Tariel `nr33_avaliacao_espaco_confinado`.
...
Regra de produto:
- a familia principal e `nr33_avaliacao_espaco_confinado`;
- o template principal deve ser `nr33_avaliacao_espaco_confinado`;
...
- `output/nr33_avaliacao_espaco_confinado/assets/`
- `output/nr33_avaliacao_espaco_confinado/pdf/`
- `output/nr33_avaliacao_espaco_confinado/manifest.json`
- `output/nr33_avaliacao_espaco_confinado/tariel_filled_reference_bundle.json`
- `output/nr33_avaliacao_espaco_confinado/pdf/nr33_avaliacao_espaco_confinado_referencia_sintetica.pdf`
