# NR33 - Avaliacao espaco confinado

- family_key: `nr33_avaliacao_espaco_confinado`
- macro_categoria: `NR33`
- kind: `inspection`
- wave: `1`
- template_codes: `nr33_avaliacao_espaco_confinado`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr33_avaliacao_espaco_confinado.
...
- prompt excepcional salvo em `prompt_fallback_sintetica_externa_nr33_avaliacao_espaco_confinado.md`
...
Descricao canonica da familia: Execucao do servico avaliacao espaco confinado no contexto da norma seguranca e saude nos trabalhos em espacos confinados, com consolidacao de evidencias, registros de campo ou base documental e conclusao tecnica auditavel.
