# NR33 - Permissao entrada trabalho

- family_key: `nr33_permissao_entrada_trabalho`
- macro_categoria: `NR33`
- kind: `inspection`
- wave: `1`
- template_codes: `nr33_permissao_entrada_trabalho`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr33_permissao_entrada_trabalho.
...
- prompt excepcional salvo em `prompt_fallback_sintetica_externa_nr33_permissao_entrada_trabalho.md`
...
Descricao canonica da familia: Execucao do servico permissao entrada trabalho no contexto da norma seguranca e saude nos trabalhos em espacos confinados, com consolidacao de evidencias, registros de campo ou base documental e conclusao tecnica auditavel.
