# NR13 - Treinamento de Operacao de Caldeira

- family_key: `nr13_treinamento_operacao_caldeira`
- macro_categoria: `NR13`
- kind: `training`
- wave: `4`
- template_codes: `nr13_treinamento_operacao_caldeira`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_treinamento_operacao_caldeira.
...
Descricao canonica da familia: Planejamento, execucao e registro do treinamento de operacao de caldeira para a equipe operacional.
