# NR13 - Calculo de Espessura Minima de Caldeira

- family_key: `nr13_calculo_espessura_minima_caldeira`
- macro_categoria: `NR13`
- kind: `calculation`
- wave: `3`
- template_codes: `nr13_calculo_espessura_minima_caldeira`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_calculo_espessura_minima_caldeira.
...
Descricao canonica da familia: Determinacao tecnica da espessura minima de caldeira a partir dos dados levantados e da memoria de calculo correspondente.
