...
- kind: `test`
- wave: `1`
- template_codes: `nr13_teste_estanqueidade_tubulacao_gas`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_teste_estanqueidade_tubulacao_gas.
...
- Identificacao do Objeto de Teste
- Escopo do Teste
- Execucao do Teste
...
Descricao canonica da familia: Execucao e registro de teste de estanqueidade em tubulacao de gas, com consolidacao de parametros, evidencias e resultado da verificacao.
