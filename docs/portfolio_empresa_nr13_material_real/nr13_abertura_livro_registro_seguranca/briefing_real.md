# NR13 - Abertura de Livro de Registro de Seguranca

- family_key: `nr13_abertura_livro_registro_seguranca`
- macro_categoria: `NR13`
- kind: `documentation`
- wave: `2`
- template_codes: `nr13_abertura_livro_registro_seguranca`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_abertura_livro_registro_seguranca.
...
Descricao canonica da familia: Estruturacao inicial do livro de registro de seguranca com consolidacao de dados basicos, referencias e orientacoes de uso.
