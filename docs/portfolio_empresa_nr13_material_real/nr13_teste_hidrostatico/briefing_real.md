...
- kind: `test`
- wave: `1`
- template_codes: `nr13_teste_hidrostatico`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_teste_hidrostatico.
...
Descricao canonica da familia: Execucao e registro de teste hidrostatico em ativo abrangido pela NR13, com parametros de teste, evidencias do procedimento e consolidacao de resultado tecnico.
