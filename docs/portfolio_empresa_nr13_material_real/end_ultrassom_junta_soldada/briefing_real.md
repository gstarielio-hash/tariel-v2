# END - Ultrassom em Junta Soldada

- family_key: `end_ultrassom_junta_soldada`
- macro_categoria: `END`
- kind: `ndt`
- wave: `5`
- template_codes: `end_ultrassom_junta_soldada`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico end_ultrassom_junta_soldada.
...
Descricao canonica da familia: Execucao e registro tecnico de ultrassom em junta soldada com consolidacao das indicacoes e do resultado do ensaio.
