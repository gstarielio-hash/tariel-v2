...
- kind: `inspection`
- wave: `1`
- template_codes: `nr13_inspecao_tubulacao`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_inspecao_tubulacao.
...
Descricao canonica da familia: Inspecao de seguranca periodica em tubulacao abrangida pela NR13, com foco em identificacao, suportacao, acessorios aparentes, sinais visuais e registros disponiveis.
