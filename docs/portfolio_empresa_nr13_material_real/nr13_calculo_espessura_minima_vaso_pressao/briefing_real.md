# NR13 - Calculo de Espessura Minima de Vaso de Pressao

- family_key: `nr13_calculo_espessura_minima_vaso_pressao`
- macro_categoria: `NR13`
- kind: `calculation`
- wave: `3`
- template_codes: `nr13_calculo_espessura_minima_vaso_pressao`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_calculo_espessura_minima_vaso_pressao.
...
Descricao canonica da familia: Determinacao tecnica da espessura minima de vaso de pressao com memoria de calculo e rastreabilidade dos dados de entrada.
