# NR13 - Adequacao de Planta Industrial

- family_key: `nr13_adequacao_planta_industrial`
- macro_categoria: `NR13`
- kind: `engineering`
- wave: `3`
- template_codes: `nr13_adequacao_planta_industrial`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_adequacao_planta_industrial.
...
Descricao canonica da familia: Avaliacao e proposta de adequacao da planta industrial com foco nos itens aplicaveis da NR13 para os ativos existentes.
