# NR13 - Reconstituicao de Prontuario

- family_key: `nr13_reconstituicao_prontuario`
- macro_categoria: `NR13`
- kind: `documentation`
- wave: `2`
- template_codes: `nr13_reconstituicao_prontuario`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_reconstituicao_prontuario.
...
Descricao canonica da familia: Levantamento, consolidacao e reconstituicao de prontuario e documentos exigidos para o ativo abrangido pela NR13.
