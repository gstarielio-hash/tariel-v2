# NR13 - PAR Projeto de Alteracao ou Reparo

- family_key: `nr13_par_projeto_alteracao_reparo`
- macro_categoria: `NR13`
- kind: `engineering`
- wave: `3`
- template_codes: `nr13_par_projeto_alteracao_reparo`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_par_projeto_alteracao_reparo.
...
Descricao canonica da familia: Elaboracao e aprovacao de projeto de alteracao ou reparo com consolidacao tecnica e rastreabilidade das decisoes associadas ao ativo.
