# END - Medicao de Espessura por Ultrassom

- family_key: `end_medicao_espessura_ultrassom`
- macro_categoria: `END`
- kind: `ndt`
- wave: `5`
- template_codes: `end_medicao_espessura_ultrassom`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico end_medicao_espessura_ultrassom.
...
Descricao canonica da familia: Execucao e registro tecnico de medicao de espessura por ultrassom em ativo ou trecho contratado, com consolidacao dos pontos avaliados e dos resultados obtidos.
