# NR13 - Projeto de Instalacao

- family_key: `nr13_projeto_instalacao`
- macro_categoria: `NR13`
- kind: `engineering`
- wave: `3`
- template_codes: `nr13_projeto_instalacao`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_projeto_instalacao.
...
Descricao canonica da familia: Elaboracao e aprovacao de projeto de instalacao com consolidacao tecnica, referencias de campo e premissas de engenharia aplicaveis ao escopo contratado.
