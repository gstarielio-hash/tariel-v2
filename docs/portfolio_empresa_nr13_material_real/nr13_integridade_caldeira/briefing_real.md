...
- kind: `inspection`
- wave: `1`
- template_codes: `nr13_integridade_caldeira`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_integridade_caldeira.
...
Descricao canonica da familia: Avaliacao de integridade em caldeira com foco em registros, evidencias de campo, complementacao de historico e consolidacao tecnica para decisao de continuidade operacional.
