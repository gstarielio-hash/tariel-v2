# NR13 - Calculo de PMTA de Vaso de Pressao

- family_key: `nr13_calculo_pmta_vaso_pressao`
- macro_categoria: `NR13`
- kind: `calculation`
- wave: `3`
- template_codes: `nr13_calculo_pmta_vaso_pressao`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_calculo_pmta_vaso_pressao.
...
Descricao canonica da familia: Determinacao tecnica da PMTA de vaso de pressao com consolidacao das premissas, dados de entrada e resultados do calculo.
