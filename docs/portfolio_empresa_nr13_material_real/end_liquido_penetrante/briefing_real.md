...
- kind: `ndt`
- wave: `5`
- template_codes: `end_liquido_penetrante`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico end_liquido_penetrante.
...
Descricao canonica da familia: Execucao e registro tecnico de ensaio por liquido penetrante com consolidacao das indicacoes e rastreabilidade do componente ensaiado.
