# NR13 - Fluxograma com Identificacao das Linhas e Acessorios

- family_key: `nr13_fluxograma_linhas_acessorios`
- macro_categoria: `NR13`
- kind: `documentation`
- wave: `2`
- template_codes: `nr13_fluxograma_linhas_acessorios`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_fluxograma_linhas_acessorios.
...
Descricao canonica da familia: Elaboracao e consolidacao de fluxograma com identificacao das linhas e acessorios vinculados aos ativos NR13.
