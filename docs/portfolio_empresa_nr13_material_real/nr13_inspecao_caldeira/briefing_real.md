...
- kind: `inspection`
- wave: `1`
- template_codes: `nr13_caldeira, nr13_inspecao_caldeira`
...
- `slot_placa_identificacao`: Placa de identificacao
  ...
  finalidade: Vincular evidencia da identificacao da caldeira por placa ou documento equivalente disponivel.
- `slot_vista_geral_caldeira`: Vista geral da caldeira
  binding_path=`caracterizacao_do_equipamento.vista_geral_caldeira` | accepted=foto
  finalidade: Registrar a vista geral da caldeira e sua implantacao imediata.
- `slot_dispositivos_de_seguranca`: Dispositivos de seguranca
  binding_path=`dispositivos_e_controles.dispositivos_de_seguranca` | accepted=foto
  finalidade: Registrar visualmente pelo menos um dispositivo de seguranca associado.
- `slot_painel_e_comandos`: Painel e comandos
  binding_path=`dispositivos_e_controles.painel_e_comandos` | accepted=foto
  finalidade: Registrar o painel, comandos ou frente operacional visivel da caldeira.
...
- `escopo_principal_diferente_de_caldeira`
- `troca_silenciosa_da_familia_principal`
- `ausencia_de_identificacao_da_caldeira`
...
Descricao canonica da familia: Familia tecnica para inspecao de caldeiras, com foco em identificacao do equipamento, condicoes visuais aparentes, dispositivos de seguranca, painel e comandos, entorno de instalacao, registros disponiveis e conclusao tecnica estruturada para revisao da Mesa.

## Proximo passo operacional ja preparado

- prompt externo salvo em `prompt_chatgpt_pro_nr13_inspecao_caldeira.md`
