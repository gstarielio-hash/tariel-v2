# END - Ensaio Visual de Solda

- family_key: `end_visual_solda`
- macro_categoria: `END`
- kind: `ndt`
- wave: `5`
- template_codes: `end_visual_solda`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico end_visual_solda.
...
Descricao canonica da familia: Execucao e registro tecnico de ensaio visual de solda com consolidacao das observacoes e do resultado do exame executado.
