# NR13 - Treinamento de Operacao de Unidades de Processo

- family_key: `nr13_treinamento_operacao_unidades_processo`
- macro_categoria: `NR13`
- kind: `training`
- wave: `4`
- template_codes: `nr13_treinamento_operacao_unidades_processo`
...
- `documentos_finais_reais`: Documentos finais reais ja emitidos
  min_items=1 | required=true | pasta=`coleta_entrada/documentos_finais_reais`
...
- `programa_e_certificacao`: Programa do treinamento e certificados usados
  min_items=1 | required=true | pasta=`coleta_entrada/programa_e_certificacao`
  finalidade: Mapear conteudo programatico, presenca, avaliacao e certificado final.
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_treinamento_operacao_unidades_processo.
...
Descricao canonica da familia: Planejamento, execucao e registro do treinamento de operacao de unidades de processo para a equipe operacional.
