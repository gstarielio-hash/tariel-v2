# NR13 - Calculo de Espessura Minima de Tubulacao

- family_key: `nr13_calculo_espessura_minima_tubulacao`
- macro_categoria: `NR13`
- kind: `calculation`
- wave: `3`
- template_codes: `nr13_calculo_espessura_minima_tubulacao`
...
- `slot_referencia_principal`: Referencia principal
  ...
  finalidade: Vincular a referencia principal do objeto do servico nr13_calculo_espessura_minima_tubulacao.
...
Descricao canonica da familia: Determinacao tecnica da espessura minima de tubulacao abrangida pela NR13 com consolidacao dos dados e da memoria de calculo correspondente.
