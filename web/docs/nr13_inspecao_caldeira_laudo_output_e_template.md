# NR13 Caldeira: Laudo Output e Template

Documento curto que fecha a segunda materializacao canonica entre:
...
- `docs/family_schemas/nr13_inspecao_caldeira.json`

Artefatos associados:

- `docs/family_schemas/nr13_inspecao_caldeira.laudo_output_seed.json`
- `docs/family_schemas/nr13_inspecao_caldeira.laudo_output_exemplo.json`
- `docs/family_schemas/nr13_inspecao_caldeira.template_master_seed.json`
...
- `dispositivos_e_controles.painel_e_comandos.referencias_texto`
...
- `{{json_path:identificacao.identificacao_da_caldeira}}`
- `{{json_path:identificacao.localizacao}}`
- `{{json_path:identificacao.placa_identificacao.referencias_texto}}`
- `{{json_path:caracterizacao_do_equipamento.vista_geral_caldeira.referencias_texto}}`
- `{{json_path:inspecao_visual.condicao_geral}}`
- `{{json_path:inspecao_visual.pontos_de_vazamento_ou_fuligem.descricao}}`
- `{{json_path:dispositivos_e_controles.leitura_dos_dispositivos_de_seguranca}}`
- `{{json_path:dispositivos_e_controles.painel_e_comandos.referencias_texto}}`
