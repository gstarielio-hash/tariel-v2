                ...
                options: {
                    ...
                    plugins: {
                        ...
                        tooltip: {
                            ...
                            titleFont: { family: "\"IBM Plex Sans\", \"Segoe UI\", sans-serif", size: 12 },
                            bodyFont: { family: "\"IBM Plex Sans\", \"Segoe UI\", sans-serif", size: 14, weight: "bold" },
                            padding: 10,
                            cornerRadius: 8,
                            displayColors: false,
                            callbacks: {
