...
WAVE_2_ROUTE_MATRIX: tuple[tuple[str, str], ...] = (
    ("nr18_inspecao_canteiro_obra", "padrao"),
    ("nr18_inspecao_frente_construcao", "padrao"),
    ("nr22_inspecao_area_mineracao", "padrao"),
    ("nr22_inspecao_instalacao_mineira", "padrao"),
    ("nr29_inspecao_operacao_portuaria", "padrao"),
    ("nr30_inspecao_trabalho_aquaviario", "padrao"),
    ("nr31_inspecao_frente_rural", "padrao"),
    ("nr32_inspecao_servico_saude", "padrao"),
    ("nr32_plano_risco_biologico", "padrao"),
    ("nr34_inspecao_frente_naval", "padrao"),
    ("nr36_inspecao_unidade_abate_processamento", "padrao"),
    ("nr37_inspecao_plataforma_petroleo", "padrao"),
    ("nr38_inspecao_limpeza_urbana_residuos", "padrao"),
)
...
@pytest.mark.parametrize(("family_key", "route_tipo_template"), WAVE_2_ROUTE_MATRIX)
def test_wave2_fixture_emits_pdf_via_catalog_runtime(
    ambiente_critico,
    family_key: str,
    ...
    with SessionLocal() as banco:
        ...
        laudo.catalog_variant_key = "wave2_fixture"
        laudo.catalog_variant_label = "Wave 2 fixture"
    ...
    resposta = client.post(
        ...
        json={
            ...
            "empresa": "Empresa Fixture Wave 2",
            "setor": "geral",
            "data": "09/04/2026",
            "laudo_id": laudo_id,
            "tipo_template": route_tipo_template,
